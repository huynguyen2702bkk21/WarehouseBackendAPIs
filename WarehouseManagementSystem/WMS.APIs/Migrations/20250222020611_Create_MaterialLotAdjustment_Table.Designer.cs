...
namespace WMS.APIs.Migrations
{
    ...
    [Migration("20250222020611_Create_MaterialLotAdjustment_Table")]
    partial class Create_MaterialLotAdjustment_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WMS.Domain.AggregateModels.InventoryIssueAggregate.InventoryIssue", b =>
                {
                    b.HasOne("WMS.Domain.AggregateModels.PersonAggregate.Customer", "customer")
                        .WithMany("inventoryIssues")
                        .HasForeignKey("customerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WMS.Domain.AggregateModels.PersonAggregate.Employee", "issuedBy")
                        .WithMany("inventoryIssues")
            ...
            modelBuilder.Entity("WMS.Domain.AggregateModels.InventoryReceiptAggregate.InventoryReceipt", b =>
                {
                    b.HasOne("WMS.Domain.AggregateModels.PersonAggregate.Employee", "receivedBy")
                        .WithMany("inventoryReceipts")
                        .HasForeignKey("employeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WMS.Domain.AggregateModels.PersonAggregate.Supplier", "supplier")
                        .WithMany("inventoryReceipts")
            ...
            modelBuilder.Entity("WMS.Domain.AggregateModels.MaterialLotAdjustmentAggregate.MaterialLotAdjustment", b =>
                {
                    b.HasOne("WMS.Domain.AggregateModels.PersonAggregate.Employee", "adjustedBy")
